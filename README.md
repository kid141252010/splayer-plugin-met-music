...
详见完整的 [更新日志 (CHANGELOG.md)](CHANGELOG.md)。

- **v1.1.1** (2026-09-06): 智能过滤服务端非预期的巨型母带 (`AI00`) 降级掉包，避免杜比全景声等音效未命中时产生巨额流量消耗。
- **v1.1.0** (2026-09-06): 接入 SPlayer-Next API Level 2，支持应用内配置 API 地址与扩展音质偏好，重构平滑降级链。
- **v1.0.2** (2026-09-06): 初始版本发布，支持基础直链解析。
